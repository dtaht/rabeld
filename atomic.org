...
Note: the iteration count as a multiple of four is only an example. In fact, it should be a multiple of the
...
The requirement to have fixed iteration count or iteration count decid

* Load/store 64 bytes at a time:


: vldm r1!,{q0-q3}; vstm r0!,{q0-q3}; subs r2,r2,#64; bne 1b

https://gcc.gnu.org/bugzilla/show_bug.cgi?id=43725

* Hmm... can I use popcount for anything?

or popcount | plen << 8? It's *way* cheaper than a hash, and the initial
table lookup is very wide. Can I get covering routes this way? What's the
distribution of routes in the first place.

Instead of depending on the plen could I reverse the count leading zeros
stuff?

https://www.raspberrypi.org/forums/viewtopic.php?f=63&t=134825

popcount is a free instruction on later SSE more or less

https://gmplib.org/list-archives/gmp-devel/2013-February/002892.html

Neon has:

VCNT (Vector Count set bits) counts the number of bits that are one in each
element in a vector, and places the results in a second vector.
which then becomes a horizontal add, add to get back the total result.x
...
* DONE I had a plan...
I spent a few hours writing up a plan for merging changes 
and I can't find it now.
** I'd put it in an unmerged repo
** TODO commit it somewhere

* I am still trying to wrap my head around the zone concept

* Idea - simplify all other logic

Always do a modify elsewhere which is an implied add.
a flush is a flush.

It turns out we only call route_add once

And adding that to my existing busted code wroked for ipov6 but failed
completely on ipv4.

We only call route modify 3 times.

* Also make sure I have the network back in a consistent state

pi2 is busted for sure. apu also.

* DONE Tomorrow's plan
...
Basically done. Current, basically borken sequence of events is:

MUCH simpler than debugging netlink, except this doesn't match in the from
or on the replace stuff. Yet.

ip route add 172.22.148.9/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.5
ip route add 172.22.148.9/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.5
ip route add fd69:3860:b137::/48 from ::/0 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
ip route add 172.26.96.100/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.1
ip route add 172.26.20.0/22 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.1
ip route add 2601:646:4101:a740::/60 from ::/0 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
ip route add ::/0 from 2601:646:4101:a740::/60 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
ip route add 172.26.16.0/24 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.1
ip route add 0.0.0.0/0 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.1
ip route add fd99::4/128 from ::/0 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
ip route add 172.26.96.103/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.1
ip route add fd99::10/128 from ::/0 table 254 metric 0 dev eno1 via fe80::ba27:ebff:fec9:3c08
ip route add 172.29.2.99/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.235
ip route add 172.22.148.9/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.5
ip route add 172.22.148.9/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.5
ip route add 172.22.148.9/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.5
ip route add 172.29.2.99/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.235
...
ip route add 0.0.0.0/0 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.1
ip route add 172.26.96.103/32 from ::/0 table 254 metric 0 dev eno1 via 172.26.16.1
ip route flush fd99::10/128 from ::/0 table 254 metric 0 dev eno1 via fe80::ba27:ebff:fec9:3c08
ip route flush fd99::4/128 from ::/0 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
ip route flush fd69:3860:b137::/48 from ::/0 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
ip route flush 2601:646:4101:a740::/60 from ::/0 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
ip route flush ::/0 from 2601:646:4101:a740::/60 table 254 metric 0 dev eno1 via fe80::32b5:c2ff:fe75:7faa
